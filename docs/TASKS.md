...
- [x] TASK-019: Add Thumbnail Safe-Zone Checker tool (spec §9.2 — overlays YouTube UI zones on a user thumbnail)
...
- [x] TASK-025: Browser verification + fixes — Playwright harness (`scripts/verify-youtube-card.mjs`, 21 checks); fixed CSP blocking YouTube images, transparent card root, html2canvas scaled-transform capture bug; verified 1x/2x exports pixel-dimensionally